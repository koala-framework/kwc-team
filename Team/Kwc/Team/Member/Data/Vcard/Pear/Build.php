 ...
 *
 */
class Team_Kwc_Team_Member_Data_Vcard_Pear_Build extends Team_Kwc_Team_Member_Data_Vcard_Pear_PEAR
{
    /**
    ...
    function addParam($param_name, $param_value, $comp = null, $iter = null)
    {
        ...
        if (Team_Kwc_Team_Member_Data_Vcard_Pear_PEAR::isError($result)) {
            return $result;
        }
    ...
    function addTelephone($text, $type = 'phone')
    {
        ...
        if (Team_Kwc_Team_Member_Data_Vcard_Pear_PEAR::isError($autoparam)) {
            return $autoparam;
        }
    ...
    {
        $vcard = $this->fetch();
        if (Team_Kwc_Team_Member_Data_Vcard_Pear_PEAR::isError($vcard)) {
             return $vcard;
        }
